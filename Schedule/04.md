...
|------             |------      |------ |-------------                                        |------                     |
| Feedback Session  | Lecture    | 13.00 | Feedback on A1 and Introduction to A2               | A, B, C, D                |
| Break             | Break      | 14.00 | Break                                               |                           |
| Activity 1        | Exercise   | 14.10 | Review Previous Tools                               | A, C                      |
| Activity 2        | Exercise   | 14.30 | Map Building to Existing                            | A, B, C                   |
| Break             | Break      | 14.50 | Break                                               |                           |
| Activity 3        | Exercise   | 15.00 | Map Issues to Battleships                           | A, B, C                   |
| BPMN              | Lecture    | 15.20 | BPMN and Markdown                                   | A, B, C                   |
| Activity 4        | Exercise   | 15.40 | BPMN and Markdown                                   | B, C                      |
...
* Simple forensic coding example
* Feedback on [A1]
* Introduction to [A2]


### Activity 1: Review Previous Tools
* Select the file from the examples for the discipline you want to work with based on your [focus area].
* What to look for: Structure, logic, readability, output.


### Activity 2: Map Building to Existing
* What to compare: Facade, structure, systems, elements, data completeness; based on your [focus area].
* Guiding questions:
 * What's the claim?
...
### Activity 3: Map Issues to Battleships
* Open the Battleships from [Week 1]
* Map the issues that you found in the previous activity.


### Activity 4
* Select the file from the B308 Proposed Reports and Models for the discipline you want to work with based on your [focus area].
...
We will hand out some example use cases and a system to generate BPMN
