...
| Reflect           | Discussion | 16.45 | Share Learning reflection with peers | D                         |
...
* _____________ Limitations - data, silos etc.
* ___ Circular Education System and Course Rules
* ___ So this course is all about Analysis
* ___ [Learning Objectives]
* ___ Course [Assignments] and Feedback [ ]
* ___ what are our assumptions for better BIM? - will they work?

## BattleBuild Experiment 1
In class experiment to simulate the challenges of multidisciplinary BIM based collaboration in projects.
* ___ You will be assigned a role a project team, this could be a BIM manager or an engineer / architect
