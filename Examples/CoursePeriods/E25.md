...
Below are the [A3](/Assignments/A3) submissions from students enrolled in 41934 E25.
...
```{dropdown} **2502**: Checking desks in IfcSpaces
...
```{dropdown} **2504**: Checking Fire Evacuation Routes in Public Buildings
...
Access at: [GitHub](https://github.com/LisannePut/BIMANALYST_G_4/tree/main/A3)
```


## Indoor & Energy / Acoustic / Daylight

```{dropdown} **2510**: Automatic daylight calculations based on room and window areas
...
Access at: [GitHub](https://github.com/kinolaj/ABIM_group10/tree/main/A3)
```
...
Access at: [GitHub](https://github.com/teiturteitur/BIManalyst_g_12/tree/main/A3)
```

```{dropdown} **2513**: Calculation of ventilation rate
...
Access at: [GitHub](https://github.com/s223928/Group-13/tree/main/A3)
```

```{dropdown} **2515**: IFC Thermal Quantifier: Automated Envelope Analysis and Reporting
...
Access at: [GitHub](https://github.com/Kolde16/Group-15/tree/main/A3)
```

```{dropdown} **2518**: Identifying IFC types in MEP models
...
```{dropdown} **2520**: IFC Column axial capacity analysis
...
Access at: [GitHub](https://github.com/ElisaSHansen/BIManalyst_g_20/tree/main/A3)
```

```{dropdown} **2522**: Manager group for structural
...
Access at: [GitHub](https://github.com/banats213/E25_41934_Structural/tree/main/A3)
```

```{dropdown} **2523**: Concrete beam width checking according to Eurocode 2
...
Access at: [GitHub](https://github.com/s223903/BIManalyst_g_23/tree/main/A3)
```

```{dropdown} **2524**: Detecting Load-Bearing Walls and Fire Safety Compliance Using OpenBIM
...
Access at: [GitHub](https://github.com/diegob1212/BIManalyst_g_24/tree/main/A3)
```

```{dropdown} **2529**: Beam Uniform Load Capacity Calculator
...
```{dropdown} **2532**: How to LCA in BIM
...
Access at: [GitHub](https://github.com/s223929/41934---Advanced-BIM-Materials/tree/main/A3)
```

```{dropdown} **2533**: LCA calculation of the STR-model
...
Access at: [GitHub](https://github.com/GustavS193940/BIManalyst_33_Sustainability/tree/main/A3)
```


## Build / Cost / Buildability / Permits

```{dropdown} *2542**: Rapid IFC-Based Architectural Cost Estimator
...
Access at: [GitHub](https://github.com/Grumstrup1/41934_G42/tree/main/A3)
```

```{dropdown} **2546**: Structural Cost Estimation using Pset-based Price Lists
...
Access at: [GitHub](https://github.com/riccardopadoan28/BIManalyst_g_46/tree/main/A3)
```

```{dropdown} **2548**: GFA estimate, area distribution and rough price estimate
...
Access at: [GitHub](https://github.com/Schabinsky/BIManalyst_g_48/tree/main/A3)
```

```{dropdown} **2549**: Web-Based IFC Space Classification for Cost Allocation
...
Access at: [GitHub](https://github.com/s204095/41934_AdvBIM/tree/main/A3)
```


## Miscellaneous

```{dropdown} **2501**: Github tutorial for OpenBIM Managers
...
Access at: [GitHub](https://github.com/NicolaiVoldstedlund/BIMmanager_g_01/tree/main/A3)
```
