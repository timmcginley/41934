...
Below are the [A3](/Assignments/A3) submissions from students enrolled in 41934 E24.
...
<!-- Group 1 -->
```{dropdown} **2401**: How to Identify Mislabeled Building Elements and Reclassify Them
...
<!-- Group 8 -->
```{dropdown} **2408**: IFC Spatial Analysis Compliance Tool
...
Access at: [GitHub](https://github.com/Ajad2024/Group8/tree/main/A3/)

```

<!-- Group 11 -->
```{dropdown} **2411**: Surface Analysis and Reverberation Calculation
...
<!-- Group 14 -->
```{dropdown} **2414**: Ventilation Validation Tool from BIM Models
...
Access at: [GitHub](https://github.com/Mathu21DTU/BIManalyst_g_14/blob/Bim_assigment_2/A3/)

```

<!-- Group 15 -->
```{dropdown} **2415**: U-Value Calculation Tool for Windows and Glazing
...
Access at: [GitHub](https://github.com/ZKA1104/BIManalyst_g_15/tree/main/A3/)

```

<!-- Group 33 -->
```{dropdown} **2433**: Extracting U-values from Model
...
<!-- Group 24 -->
```{dropdown} **2424**: Automated Beam Load Calculation with BlenderBIM
...
Access at: [GitHub](https://github.com/Dupont2001/BIManalyst_g_24/tree/main/A3/)

```

<!-- Group 27 -->
```{dropdown} **2427**: Column Dimension Verification Tool for IFC Models
...
Access at: [GitHub](https://github.com/s237221/BIManalyst_g_27/tree/main/A3/)

```

<!-- Group 28 -->
```{dropdown} **2428**: Wind load visualization using Matplotlib
...
Access at: [GitHub](https://github.com/FrederikJM/BIManalyst_g_28/tree/main/A3/)
...
<!-- Group 4 -->
```{dropdown} **2404**: Using Python and Ifcopenshell to estimate building's CO2 emission
...
<!-- Group 23 -->
```{dropdown} **2423**: Volume Calculation for Objects in an IFC-File
...
<!-- Group 34 -->
```{dropdown} **2434**: How to identify co2 emissions from flooring in a building
...
Access at: [GitHub](https://github.com/Emiliefoged/analyst34/tree/main/A3/)

```

<!-- Group 35 -->
```{dropdown} **2435**: CO₂ Footprint Calculation Tool for Structural Concrete
...
<!-- Group 36 -->
```{dropdown} **2436**: Facade Area Analyzer
...
Access at: [GitHub](https://github.com/tile227/Group36/tree/main/A3/)

```

<!-- Group 37 -->
```{dropdown} **2437**: CO2 footprint of building element
...
Access at: [GitHub](https://github.com/Group37-Materials/Group37/tree/main/A3/)

```

<!-- Group 38 -->
```{dropdown} **2438**: Automatization of matching Ifc data with environmental data
...
Access at: [GitHub](https://github.com/fcBIM/gruppe38/blob/main/Assignments/Assignment 3/)
...
<!-- Group 26 -->
```{dropdown} **2426**: Automated data- and cost collection
...
Access at: [GitHub](https://github.com/OliverBIM/BIManalyst_g_26/blob/main/A3/)

```

<!-- Group 40 -->
```{dropdown} **2440**: Modifying the extracted ifc type name from model
...
<!-- Group 41 -->
```{dropdown} **2441**: Estimating the cost of facadeelements through IfcPsets
...
Access at: [GitHub](https://github.com/A11016/BIManalyst_g_41/tree/main/A3/)

```

<!-- Group 44 -->
```{dropdown} **2444**: Extracting IFC Element Properties: A Guide to Accessing Column Volumes with ifcopenshell
...
Access at: [GitHub](https://github.com/lillian-al/BIManalyst_g_44/blob/main/A3/)
...
<!-- Group 22 -->
```{dropdown} **2422**: How to display IFC data in Speckle
...
<!-- Group 25 -->
```{dropdown} **2425**: Guide to getting into Github Desktop
...
Access at: [GitHub](https://github.com/s203910/BIManalyst_g_25/tree/main/A3/)
