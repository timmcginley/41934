...
| **Models** |  Advanced Building Design Existing B308 |
...
<!--- 2026 - groups present the challenge they found -->
...
### Introduction
In the Advanced Building Design Course students submit Disciplinary specific BIM models in IFC along with Disciplinary 'subject reports' and a 'client report' which summarises the interdisciplinary transformation of an existing building.

## A1.1 Find and log design issues
* Find the issue
   * Document and log the issue in the google form and in your markdown file
* What is the cause?
   * Is it a design issue?
      * Identifying limitations of B308 analysis reports
   * Is it a modelling issue?
      * Identifying limitations of B308 model
   * Is it a tool issue?
      * Identifying limitations of tool


## A1.2 Potential Solutions

* Whats the potential solution from each of these perspectives?
   * For design?
      * Identify design opportunities from the B308 analysis reports
   * For modelling?
      * Identify improvements to modelling the B308 model
   * For tool?
      * Identify improvements to the previous ABIM tools.
...
For instance you would get an existing model report to analyse  ...

**Content > IFC Models & Reports > Existing 308 Model and Reports > CES_BLD_25_06_Report**
...
2. Your focus area.
3. Your identified issues
4. Your identified possible solutions
5. The claim you are checking
6. The report and page number or section that you found the claim in.
7. Description of your script
...
Please only submit a .txt file to DTU learn that contains the link to your github repository.
Please also note we can only see public github repositories.
...
### Week 3
* Existing building 308 analysis
* Issue logging
* Potential solutions logging
...
## Submission 2026
Enrolled students submit on DTU Learn [here](https://learn.inside.dtu.dk/d2l/lms/dropbox/admin/mark/folder_submissions_users.d2l?db=74016&ou=326240)
...
[Advanced Building Design]: https://timmcginley.github.io/41936/
