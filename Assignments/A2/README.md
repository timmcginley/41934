...
### Learning Objectives
12. Evaluate [software licensing](https://github.com/timmcginley/41934/blob/main/Concepts/Software_licences/README.md) suitability and implications for the OpenBIM tool you develop or modelling tool you use.
...
### Learning Objectives:
6. Create, fork, branch and collaborate on the development of an OpenBIM tool in Python with peers in a [code repository](https://github.com/timmcginley/41934/blob/main/Concepts/Github/README.md).

### Aim: 
4. Provide professional disciplinary guidance based on OpenBIM analysis.
9. Identify and model a BIM use case based on the BIM challenges identified from analysis of an OpenBIM project in [BPMN](https://github.com/timmcginley/41934/blob/main/Concepts/BPMN/README.md).
10. Identify an appropriate [development methodology](https://github.com/timmcginley/41934/blob/main/Concepts/Development_methodology) for an OpenBIM tool or model to different use cases.
...
In this assignment we will develop a tool / workflow based on the use case you defined in the [previous assignment](https://github.com/timmcginley/41934/blob/main/Assignment/A3).<br>
The tool must:
* Address your [use case](https://github.com/timmcginley/41934/blob/main/Uses):
...
[modelling]: https://github.com/timmcginley/41934/blob/main/Roles/Modeller
[analysing]: https://github.com/timmcginley/41934/blob/main/Roles/Analyst
