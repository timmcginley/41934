...
| **Models** |  Advanced Building Design Buildings #2601,#2602,#2606,#2608,#2508 and #2508 |
...
<!-- 2026 - Add a specific regualtion to the assignment - i.e. BR18 - MANAGER COLLATE ALL THE REGS THAT NEED TO BE CHECKED. -->
...
-->
## Submission 2026
Enrolled students submit on DTU Learn [here](https://learn.inside.dtu.dk/d2l/lms/dropbox/admin/mark/folder_submissions_users.d2l?db=74017&ou=326240)
...
* 10 Identify an appropriate [development methodology](/Concepts/DevelopmentMethodology.md) for an OpenBIM tool or model to different use cases.
